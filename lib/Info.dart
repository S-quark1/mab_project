  ...
  void initState() {
    ...
    slides!.add(
      Slide(
        ...
        pathImage: "assets/image/slide1.png",
      ),
    );
    slides!.add(
      Slide(
        title: "Slide2",
        description: "Save time and don't waste on long searches",
        pathImage: "assets/image/slide2.png",
      ),
    );
    slides!.add(
      Slide(
        title: "Slide3",
        description: "longlonglonglonglonglonglonglonglnoglonglonglong",
        pathImage: "assets/image/slide3.png",
      ),
    );
  }
